...
pub const pkgs = struct {
    pub const requestz = std.build.Pkg{
        .name = "requestz",
        .path = ".gyro/requestz-ducdetronquito-0.1.1-68845cbcc0c07d54a8cd287ad333ba84/pkg/src/main.zig",
        .dependencies = &[_]std.build.Pkg{
            std.build.Pkg{
                .name = "http",
                .path = ".gyro/http-ducdetronquito-0.1.3-02dd386aa7452ba02887b98078627854/pkg/src/main.zig",
            },
            std.build.Pkg{
                .name = "h11",
                .path = ".gyro/h11-ducdetronquito-0.1.1-5d7aa65ac782877d98cc6311a77ca7a8/pkg/src/main.zig",
                .dependencies = &[_]std.build.Pkg{
                    std.build.Pkg{
                        .name = "http",
                        .path = ".gyro/http-ducdetronquito-0.1.3-02dd386aa7452ba02887b98078627854/pkg/src/main.zig",
            ...
            std.build.Pkg{
                .name = "network",
                .path = ".gyro/zig-network-MasterQ32-b9c91769d8ebd626c8e45b2abb05cbc28ccc50da/pkg/network.zig",
            },
        },
    };
